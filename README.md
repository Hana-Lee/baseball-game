...
* 모든 점수는 설정된 최대 추측 가능 횟수 만큼 아래의 공식대로 계산 된다.
	...
	* 수비는 기본 횟수보다 적을 경우 점수가 1.5배씩 줄어든다 (▼) (5회 1회)
	* 수비는 기본 횟수보다 많을 경우 점수가 1.5배씩 늘어난다 (▲) (15회 20회)
	* 점수 예
	```
	** 모든 공격 점수는 5명 기준 **
	5회 공격 1등 150점 (1.5배 ▲)
	...
	15회 공격 1등 50점 (1.5배 ▼)
	20회 공격 1등 25점 (1.5배의 1.5배 ▼)

	** 모든 수비 점수는 4명 기준 **
	5회 수비 0명 80점 (1.5배 ▼)
    1회 수비 0명 40점 (1.5배의 1.5배 ▼)

	15회 수비 0명 240점 (1.5배 ▲)
	20회 수비 0명 360점 (1.5배의 1.5배 ▲)
	```
* 수비 (기본 10회 기준)
	* 참여 유저수에 40을 곱한 점수가 기준이 된다.
	* 4명중 0명 맞춤 160점
	* 4명중 1명 맞춤 140점
	* 4명중 2명 맞춤 120점
	* 4명중 3명 맞춤 100점
...
* 종합점수는 추측가능횟수 점수 + 생성숫자갯수 점수 로 계산된다.
	* 단 숫자를 못맞추고 게임이 끝났을경우 기본점수만으로 계산된다.
	...
	15회 추측 가능 + 3개 1등 : 50 + 100 = 150점
	15회 추측 가능 + 2개 1등 : 50 + 50 = 100점

	= 수비 점수는 4명 기준
	10회 추측 가능 + 4개 0명 : 160 + 80 = 240점
