 ...
 */
@Component
public class GuessNumberValidator extends AbstractNumberValidator implements ConstraintValidator<ValidGuessNumber, PlayerDto.Update> {
	...
	@Override
	protected boolean isNotCorrectNumberLength(GameRoom gameRoom, String numberString) {
